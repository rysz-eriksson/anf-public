    ...
    <EmployeeUl>
      {employees.map((employee) => (
        <EmployeeLi key={employee.id}>
          ...
          <EmployeeButtons>
            <Button variant="OUTLINED" disabled={!onGiveRiseClick}
              {...(onGiveRiseClick && { onClick: () => onGiveRiseClick(employee) })
            }>
              <ButtonIcon>⬆︎</ButtonIcon> Daj podwyżkę
            </Button>
            <Button variant="OUTLINED" disabled={!onFireClick}
              {...(onFireClick && { onClick: () => onFireClick(employee) })
            }>
